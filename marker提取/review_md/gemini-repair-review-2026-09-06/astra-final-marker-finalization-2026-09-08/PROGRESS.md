...
- 已独立接受：63 条（34 + 27 + 2）。
- 已确认剔除：6 条。
- 221 条复核：已完成 116 条，剩余 105 条；其中原值接受 111、纠正后接受 2、剔除 1、转待议 2。
- 暂缓待议：396 条（原 394 + 本轮新增 2）。
- 当前工作版 active marker：2484 条（2490 - 6）；已同步 M01808、M02348 两项纠正。
